Function CreateLevel()
	...
	;	BackGroundTexture2=myLoadTexture("data\graphics\backgroundtex "+ex$+"2.bmp",1)
		...
		AddVertex (surface,-10,1,10,0,0)
		AddVertex (surface,LevelWidth+10,1,10,LevelWidth+20,0)
		AddVertex (surface,-10,1,0,0,10)
		AddVertex (surface,LevelWidth+10,1,0,LevelWidth+20,10)
		AddTriangle (surface,0,1,2)
		AddTriangle (surface,2,1,3)
		
		AddVertex (surface,-10,1,-LevelHeight,0,0)
		AddVertex (surface,LevelWidth+10,1,-LevelHeight,LevelWidth+20,0)
		AddVertex (surface,-10,1,-LevelHeight-10,0,10)
		AddVertex (surface,LevelWidth+10,1,-LevelHeight-10,LevelWidth+20,10)
		AddTriangle (surface,4,5,6)
		AddTriangle (surface,6,5,7)
		
		AddVertex (surface,-10,1,0,0,0)
		AddVertex (surface,0,1,0,10,0)
		AddVertex (surface,-10,1,-LevelHeight,0,LevelHeight)
		AddVertex (surface,0,1,-LevelHeight,10,LevelHeight)
		AddTriangle (surface,8,9,10)
		AddTriangle (surface,10,9,11)
		
		AddVertex (surface,LevelWidth,1,0,0,0)
		AddVertex (surface,LevelWidth+10,1,0,10,0)
		AddVertex (surface,LevelWidth,1,-LevelHeight,0,LevelHeight)
		AddVertex (surface,LevelWidth+10,1,-LevelHeight,10,LevelHeight)
...
Function CreateLevelChunk(ChunkX,ChunkZ)
	...
	Else
		EntityTexture WaterEntity(CurrentLevelChunk),WaterTexture(0)
	EndIf
...
Function UpdateWater(x,y,radius)
	...
	PositionTexture WaterFallTexture,0,((LevelTimer) Mod 50)/50.0
